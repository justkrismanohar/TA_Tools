...
//						Marksheet markingSlip = new Marksheet(item.getAbsolutePath(), filename, true);
//						markingSlip.loadOrCreateSheet(MarkingProcess.getSheetWithMarksName());
//						markingSlip.copyColumnFromThatMarksheetCurrentSheetIntoThisMarksheetCurrentSheet(2,0, fixed);
...
//            };
//            
//            performActionInFileFromStartToEnd(new File(outputDir), copyColumn,0,-1);
...
//            
            ...
            String markSlipDir = "C:\\Users\\krism\\Downloads\\A3\\Submissions\\markslips";
            String gatherFromDir = "C:\\Users\\krism\\Downloads\\A3\\Submissions\\late-output";
            ...
            performActionInFileFromStartToEnd(new File(gatherFromDir), gatherMarkingSlips,0,-1);
